...
//Unique values
const map= new Map() //Map Creation
map.set('IN', "India")
...
for (const [key,value] of myObj) {    //myObj(that is an object) is not iterable by this method
    console.log(key, ':- ',value);      //4.js me isko traverse ka treeka hai, use key and myobj[key]
}
